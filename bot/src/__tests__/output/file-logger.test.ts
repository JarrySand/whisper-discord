...
describe("FileLoggerService", () => {
  ...
  describe("ログ記録", () => {
    ...
    test("複数のログを追加できる", async () => {
      ...
      await service.log(
        createMockResult({ displayName: "Alice", text: "こんにちは" }),
      );
      await service.log(
        createMockResult({ displayName: "Bob", text: "おはよう" }),
      );
      await service.log(
        createMockResult({ displayName: "Alice", text: "いい天気ですね" }),
      );
  ...
  describe("参加者カウント", () => {
    test("参加者がフッターに記録される", async () => {
      ...
      await service.log(
        createMockResult({ displayName: "Alice", text: "Hello" }),
      );
      await service.log(createMockResult({ displayName: "Bob", text: "Hi" }));
      await service.log(
        createMockResult({ displayName: "Charlie", text: "Hey" }),
      );
      await service.log(
        createMockResult({ displayName: "Alice", text: "How are you?" }),
      );
